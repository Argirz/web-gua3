<x-admin-layout judul="Manajemen Brosur">
    <x-slot name="headerAction">
        <a href="{{ route('admin.brosur.create') }}" class="btn bg-white text-brand-900 hover:bg-brand-50 shadow-sm text-sm px-4 py-2">+ Tambah Berkas</a>
    </x-slot>
